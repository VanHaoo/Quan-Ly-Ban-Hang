...
$stmt = $pdo->query("
    SELECT sp.*, l.ten_loai, th.ten_thuong_hieu, d.ten_dvt,
           (SELECT COUNT(*) FROM BIEN_THESANPHAM WHERE ma_san_pham = sp.ma_san_pham) as so_bien_the
    FROM SANPHAM sp
    LEFT JOIN LOAISANPHAM l ON sp.ma_loai = l.ma_loai
    LEFT JOIN THUONGHIEU th ON sp.ma_thuong_hieu = th.ma_thuong_hieu
    LEFT JOIN DONVITINH d ON sp.ma_dvt = d.ma_dvt
        ...
        <table class="data-table" id="productTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><?= formatMoney($p['gia_ban']) ?></td>
